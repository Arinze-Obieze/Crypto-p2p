...
function Sidebar() {
    return (
        <aside className="w-72 bg-gray-100  border-r-2 border-gray-200 min-h-full h-screen flex flex-col items-center pt-5 pb-2 space-y-7">
            {/* Menu items */}
            <div className="w-full pr-3 flex flex-col gap-y-1 fill-gray-500 text-sm">
                ...
                <Link to={'/'}>
                    <MenuItem icon={<svg className="h-5 w-5 !fill-yellow-500 group-hover:fill-yellow-600 dark:fill-gray-600  transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                {/* <Link to={'/deposit'}>
                    <MenuItem icon={<svg className="h-5 w-5 group-hover:fill-yellow-600 dark:fill-gray-600 transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <g>
                ...
                <Link to={'/account-overview'}>
                    <MenuItem icon={<svg className="h-5 w-5 group-hover:fill-yellow-600 dark:fill-gray-600  transition-colors duration-200" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full pr-3 flex flex-col gap-y-1 fill-gray-500 text-sm">
                ...
                <Link to={'/account-overview'}>
                    <MenuItem icon={<BsBank className="h-5 w-5 group-hover:fill-yellow-600 dark:fill-gray-600  transition-colors duration-200" />} text="Account Overview" />
                </Link>

                <Link to={'/balance'}>
                    <MenuItem icon={<AiOutlineWallet className="h-5 w-5 group-hover:fill-yellow-600 dark:fill-gray-600  transition-colors duration-200" />} text="Balance" />
                </Link>
                ...
                <Link to={'/deposit'}>
                    <MenuItem icon={<PiHandCoinsBold className="h-5 w-5 group-hover:fill-yellow-600 dark:fill-gray-600  transition-colors duration-200" />} text="Deposit" />
                </Link>

                <Link to={'/convert'}>
                    <MenuItem icon={<RiContractLeftRightFill className="h-5 w-5 group-hover:fill-yellow-600 dark:fill-gray-600  transition-colors duration-200" />} text="Convert" />
                </Link>
            </div>
            {/* Profile items */}
            <div className="w-full pr-3 flex flex-col gap-y-1 fill-gray-500 text-sm">
                ...
                <MenuItem className="pb-8 " icon={<svg className="h-5 w-5 group-hover:fill-yellow-600   dark:fill-gray-600  transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
